...
import { ActiveCard, InactiveCard } from './components';

function App() {
  const [activeCard, setActiveCard] = useState(1);  

  return (
    <div className="font-poppins m-auto lg:mt-24 mt-16 md:px-16 px-4 text-gray-500">
        {/*header text*/}
        <div className="text-center mx-auto max-w-screen-lg">
          ...
          <p className="font-normal leading-relaxed lg:text-base text-sm">{data.subTitle}</p>
        </div>
        {/*Accordion*/}
